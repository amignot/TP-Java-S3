...
/**
 * Classe HierarchiqueVisiteur qui permet de créer un Visiteur qui affiche 
...
public class HierarchiqueVisiteur implements Visiteur{
	...
	/**
	 * Cette méthode permet d'afficher le nom d'un fichier visité et sa taille 
	...
	/**
	 * Cette méthode permet d'afficher le nom d'un répertoire visité
