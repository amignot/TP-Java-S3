...
/**
 * Cette classe affiche dans un repère orthonormé une courbe de températures à
 * partir de données météorologiques notifiées.
 * 
...
public class Grapheur extends JFrame implements Observateur {
	 ...
	 */
	@Override
	public void modifierDonnees(final Donnee donnee) {
		// Confinement EDT
